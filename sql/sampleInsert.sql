...
insert into user_order(user_name,order_date,Id,quantity,expected_date,current_location) values ('student','2021-02-16 20:38:40',3,3,'2021-02-19 20:38:40','ottawa, ON');
insert into user_order(user_name,order_date,Id,quantity,expected_date,current_location) values ('stduent','2021-02-17 20:38:40',4,5,'2021-02-20 20:38:40','ottawa, ON');
insert into user_order(user_name,order_date,Id,quantity,expected_date,current_location) values ('student','2021-02-18 20:38:40',4,1,'2021-02-21 20:38:40','ottawa, ON');
insert into user_order(user_name,order_date,Id,quantity,expected_date,current_location) values ('student','2021-02-19 20:38:40',6,1,'2021-02-22 20:38:40','ottawa, ON');
